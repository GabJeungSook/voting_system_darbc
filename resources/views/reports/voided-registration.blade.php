<div>
    <div class="flex justify-center space-x-1">
      ...
      <div>
        ...
        <h1 class="text-center font-semibold text-lg mt-1">Voided Registration</h1>
      </div>
            ...
            <table class="min-w-full border border-gray-600">
                <tbody class="bg-white">
                    <tr class="border-t border-gray-600">
                        ...
                        <th  class="bg-indigo-800 py-2 pl-4 pr-3 text-left text-sm uppercase font-semibold text-white sm:pl-3 border-r">Name</th>
