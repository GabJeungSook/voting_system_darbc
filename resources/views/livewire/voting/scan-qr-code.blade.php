<div>
    <div class="grid grid-cols-3 mt-56">
        <div class="grid col-start-2">
            <img src="{{ asset('images/darbc.png') }}" class="mx-auto xl:h-20 xl:w-20 sm:h-16 sm:w-24" alt="">
        </div>
    </div>
    <div>
        <h1 class="text-4xl text-center font-bold text-gray-700 mt-5">DARBC ELECTION 2023</h1>
    </div>
