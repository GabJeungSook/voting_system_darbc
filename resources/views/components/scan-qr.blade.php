      ...
      {{-- <div class="flex min-h-0 flex-1 flex-col bg-sidebar">
        ...
        <div class="flex font-sans flex-1 flex-col overflow-y-auto">
          <nav class="flex-1 space-y-1 px-2 py-4">
            ...
            <a href="{{ route('voting.dashboard') }}"
              class="{{ request()->routeIs('voting.dashboard') ? 'bg-violet-800' : '' }} hover:bg-violet-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium">
            ...
            <a href="{{ route('voting.voting-module') }}"
            class="{{ request()->routeIs('voting.voting-module') ? 'bg-violet-800' : '' }} hover:bg-violet-800 text-white group flex items-center rounded-md px-2 py-2 text-sm font-medium">
